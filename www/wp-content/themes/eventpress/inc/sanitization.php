 ...
 */
function eventpress_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function eventpress_sanitize_css( $css ) {
 ...
 */
function eventpress_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function eventpress_sanitize_email( $email, $setting ) {
 ...
 */
function eventpress_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function eventpress_sanitize_html( $html ) {
 ...
 */
function eventpress_sanitize_image( $image, $setting ) {
 ...
 */
function eventpress_sanitize_nohtml( $nohtml ) {
 ...
 */
function eventpress_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function eventpress_sanitize_number_range( $number, $setting ) {
 ...
 */
function eventpress_sanitize_select( $input, $setting ) {
 ...
 */
function eventpress_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function eventpress_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function eventpress_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
...
function eventpress_sanitize_date_time( $input ) {
