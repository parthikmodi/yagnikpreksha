...
class Eventpress_Customizer_Notify {
	...
	public function setup_actions() {
		...
		add_action( 'wp_ajax_quality_customizer_notify_dismiss_action', array( $this, 'eventpress_customizer_notify_dismiss_recommended_action_callback' ) );

		add_action( 'wp_ajax_ti_customizer_notify_dismiss_recommended_plugins', array( $this, 'eventpress_customizer_notify_dismiss_recommended_plugins_callback' ) );
	...
	public function eventpress_customizer_notify_dismiss_recommended_plugins_callback() {
		...
		if ( ! empty( $action_id ) ) {
			...
			update_option( 'eventpress_customizer_notify_show_recommended_plugins', $eventpress_lite_customizer_notify_show_recommended_plugins );
		}
		die(); 
	}
