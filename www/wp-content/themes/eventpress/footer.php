<?php 
	...
	$footer_ti_sepr				= get_theme_mod('footer_ti_sepr',get_template_directory_uri() . '/images/section-hi.png'); 
			...
			<?php if($hide_show_foo_top == '1') { ?> 
				<div class="row" id="foot-top">
					<div class="col-md-12 text-center footer-logo">
						...
						<?php } ?>	
						<img class="title-seprator" src="<?php echo esc_url($footer_ti_sepr); ?>" alt="">
					</div>
				</div>
			<?php } ?>
			...
			<div class="container-fluid">
				<div class="row footer-copyright">
					<div class="col-12">
						...
						<?php  }else{ ?>	
							<p><?php esc_html_e('© 2019 All Right Reserved | EventPress WordPress Theme','eventpress'); ?></p>
						<?php } ?>	
					</div>
				</div>
			</div>
